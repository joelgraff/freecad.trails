...
def create(geometry, object_name='', parent=None, no_visual=False, zero_reference=False):
    ...
    if parent:
        parent.addObject(_obj)

    HorizontalAlignment(_obj)

    _obj.Proxy.set_geometry(geometry, zero_reference)

    #_ViewProviderWire(_obj.ViewObject)
...
class HorizontalAlignment(AlignmentFunc):
    ...
    def __init__(self, obj):
        ...
        super(HorizontalAlignment, self).__init__(obj)
...
class ViewProviderHorizontalAlignment(_ViewProviderWire):
    """
